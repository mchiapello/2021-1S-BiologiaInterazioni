...
- Avete mai sentito parlare di quei prodotti che uccido il 99% dei germi?    
- Noi sappiamo che i germi sono cattivi: batteri, virus, funghi causano malattie e quindi vanno sterminati

- L'obiettivo di questo modulo è farvi capire quanto questa CREDENZA POPOLARE sia sbagliata e non abbia alcun senso

- Vedremo come batteri, funghi e virus abbiano un profondo significato ecologico e siano indispensabili per la nostra saluta e per quella delle piante
]
---
layout: true
class: clear
...
.font180[.bold[About the teacher `r fontawesome::fa("chalkboard-teacher", fill = "black")`]]
...
- Concept maps: in questo corso proveremo ad utilizzare le concept maps come strumento di apprendimento. Vi verrà quindi chiesto di schematizzare i concetti appresi tramite mappe concettuali per riuscire a fissare i contenuti

- Feedback: E' studiato e risaputo che l'atmosfera sociale, emotova ed intellettuale della classe influenzi l'apprendimento. Quindi interagiamo => sono disponibile a rispondere e chiarire ogni dubbio sia in classe che fuori (Slack). Vi chiederò anche dei feedback sulle lezioni per capire se stiamo andando nella giusta direzione. 
...
.font180[.bold[Course overview - Lecture]]

- .font120[Plant Microbiota (5 hours) `r fontawesome::fa("tree", fill = "green")`] 

- .font120[Ecological Significance of Viruses (2 hours) `r anicon::cia("images/virus-3128.png", anitype = "hover")`]

- .font120[Reproducible research (1 hour) `r fontawesome::fa("flask", fill = "grey")`]

- .font120[Elements of Bioinformatics (2 hours) `r fontawesome::fa("laptop-code", fill = "grey")`]

---


.font180[.bold[Course overview - Practical]]

- .font120[Wet lab: How to perform a PCR (3 hours) `r fontawesome::fa("dna", fill = "grey")` ]
 
- .font120[Dry lab: How to perform alignments/blast/phylogenetic trees (1.5 hours) `r fontawesome::fa("align-justify", fill = "grey")` ]

- .font120[Dry lab: How to perform microbiota analysis (1.5 hours) `r fontawesome::fa("bacteria", fill = "grey")` ]
...
> .font70[indica la totalità del patrimonio genetico posseduto dal microbiota, cioè i geni che quest’ultimo è in grado di esprimere]
...
- .n[Commensalismo: relazione tra due organismi in cui uno dei due beneficia senza danneggiare l'altro]

- .n[Parassitismo: relazione tra due organismi in cui uno dei due beneficia danneggiando l'altro]
...
- .font80[**Rhizosphere**: .white[The region of soil in the vicinity of plant roots that is influenced by plant-derived nutrients and oxygen availability; it is not a region of definable size or shape, but instead consists of a gradient in chemical, biological and physical properties that change both radially and longitudinally along the root.]]


- .font80[**Phyllosphere**: .white[All the aboveground organs of plants, including the leaf, flower, stem and fruit.]]


- .font80[**Endophytes**: .white[The microorganisms residing within plant tissues (the endosphere), such as leaves, roots or stems.]]


- .font80[**bulk soil**: .white[is soil outside the rhizosphere. bulk soil is not penetrated by plant roots]]
...
```{r echo=FALSE, out.width = "400px"}
knitr::include_graphics("images/Lesson1_feebback.png")
```

.m0tbp[
.center[https://bit.ly/3B8iTr2]
]
