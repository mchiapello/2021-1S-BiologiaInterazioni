...
- .font120[Plant Microbiota `r fontawesome::fa("tree", fill = "green")`] 

- .font120[Ecological Significance of Viruses `r anicon::cia("images/virus-3128.png", anitype = "hover")`]

- .font120[Reproducible research `r fontawesome::fa("flask", fill = "grey")`]

- .font120[Elements of Bioinformatics `r fontawesome::fa("laptop-code", fill = "grey")`]
...
- .font120[Wet lab: How to perform a PCR `r fontawesome::fa("dna", fill = "grey")` ]
 
- .font120[Dry lab: How to perform alignments/blast/phylogenetic trees `r fontawesome::fa("align-justify", fill = "grey")` ]

- .font120[Dry lab: How to perform microbiota analysis `r fontawesome::fa("bacteria", fill = "grey")` ]
