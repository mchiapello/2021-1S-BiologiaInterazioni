...
BibOptions(check.entries = FALSE,
           ...
           hyperlink = FALSE,
           dashed = FALSE)
bib <- ReadBib("RR/bib/myBib.bib", check = FALSE)
```
...
knitr::include_graphics("RR/images/environmental-data-science-r4ds-general.png")
```
...
knitr::include_graphics("RR/images/001.jpg")
```
...
knitr::include_graphics("RR/images/thenamiracleoccurs.jpg")
```
...
knitr::include_graphics("RR/images/motivatedReasoning.png")
```
...
knitr::include_graphics("RR/images/Screenshot 2020-05-19 at 06.49.21.png")
```
<br><br><br>
.marco[
...
knitr::include_graphics("RR/images/RMarkdownOutputFormats.png")
```
...
knitr::include_graphics("RR/images/versionControl.jpg")
```
]
