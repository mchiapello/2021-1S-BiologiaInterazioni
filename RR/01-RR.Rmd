...
```{r ds-class-options, echo=FALSE, out.width = "1000px"}
...
```{r motivate, echo=FALSE, out.width = "1001px"}
...
knitr::include_graphics("images/LessonRR_feedback.png")
```

.m0tbp[
.center[https://bit.ly/3FRII16]
]
