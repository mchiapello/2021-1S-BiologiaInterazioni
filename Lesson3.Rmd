...
knitr::include_graphics("docs/images/virusPoll.png")
```
]
...
- Non è vero che un diamante è per sempre, ma un herpes virus si
]
...
```{r echo=FALSE, out.width = "400px"}
knitr::include_graphics("images/LessonVirus.png")
```

.m0tbp[
.center[https://bit.ly/3CZJ18t]
]
