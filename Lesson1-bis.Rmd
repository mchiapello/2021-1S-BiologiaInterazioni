...
.n30[
- Organismi comuni tra diversi microbiomi, supposti giocare un ruolo chiave nelle funzioni dell'ecosistema

- Analisi del core microbiota è più complessa che un semplice diagramma di VENN

- Definizione OTU: Operation taxonomical unit (è una definizione operativa usata per classificare gruppi di individui che sono fortemente imparentati)
...
```{r echo=FALSE, out.width="1020px"}
knitr::include_graphics("images/shade1.png")
```

.right[.font50[(Shade et al., 2011)]]

???

.n30[
- L'analisi membership considera gli OTU condivisi

- Si limita a presenza assenza
...
```{r echo=FALSE, out.width="1020px"}
knitr::include_graphics("images/shade2.png")
```
...
.n30[
- L'analisi membership ignora l'abbondanza relativa delle OTU presenti

- L'analisi dell'abbondanza Contribuisce a darci informazioni ecologiche più complete
...
```{r echo=FALSE, out.width="1020px"}
knitr::include_graphics("images/shade3.png")
```
...
.n30[
- Una sfida fondamentale nello studio del microbioma è correlare la composizione alla funzione biologica

- **Ridondanza filogenetica**: quando più OTU dalla stesso lignaggio sono presenti in diversi microbiomi

- **Ridondanza funzionale**: quando più OTU isvolgono la stessa azione (fissazione azotata)

- Domanda interessante: Le OTU ridondanti devono contare allo stesso modo delle OTU uniche nella definizione del core microbiota?
...
```{r echo=FALSE, out.width="1020px"}
knitr::include_graphics("images/shade4.png")
```
...
.n30[
- Il microbiota è dinamico nello spazio e nel tempo

- Il sistema di detection delle OTU può quindi rilevare OTU transienti (queste non devono contare)

- Contano solo le OTU trovate in tutte le osservazioni (o nella maggior parte)
]
...
```{r echo=FALSE, out.width="1020px"}
knitr::include_graphics("images/shade5.png")
```
...
???
.n30[
- Il concetto di core microbiota può anche includere informazioni sull'interazione tra OTU

- L'idea di identificare il core microbiota in base alle relazioni tra diversi taxa, omettendo i taxa che non presentano interazioni

- Questo approccio è più difficile poichè richiede moltissime informazioni pregresse per la predizione delle connessioni
]
...
- Piccolo numero di taxa/OTU, che sono fortemente interconnessi e hanno un forte effetto sulla comunità
...
```{r echo=FALSE, out.width="800px"}
knitr::include_graphics("images/agler1.png")
```

.right[.font50[(Agler et al., 2016)]]
...
- correlazione positiva in arancione    

- correlazione negastiva in trattegiato nero    

- lo spessore delle linee indica l'intensità della correlazione
...
.center[
.middle[
<iframe width="560" height="315" src="https://www.youtube.com/embed/qzusVw4Dp8w" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
]
https://bit.ly/3FFx1dM
]
...
.center[
.middle[
<iframe width="560" height="315" src="https://www.youtube.com/embed/_lD8JyAbwEo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
]

https://bit.ly/3ALDQXI
]
...
knitr::include_graphics("images/Lesson1b_feedback.png")
```

.m0tbp[
.center[https://bit.ly/2YMlZD3]
]
